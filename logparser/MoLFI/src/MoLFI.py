...
import pandas as pd
import hashlib
from logparser.MoLFI.src import logloader
...
class LogParser:
    ...
    def parse(self, log_file):
        ...
        df_event["EventTemplate"] = df_event["EventTemplate"].str.replace("#spec#", "<*>", regex=False)
        ...
        log_dataframe["EventTemplate"] = log_dataframe["EventTemplate"].str.replace("#spec#", "<*>", regex=False)
