...
benchmark_dir = "../../benchmark/LogMerge/module"
benchmark_file = "LogMerge_noregex.csv"
...
def main():
    ...
    for name_data, data_setting in SETTING_PARAMS.items():
        parser = LogMerge.LogMerge(
            ...
            log_format=data_setting['log_format'], regexs=[], keep_para=True,
            n_merge=data_setting['n_merge'], st=data_setting['st'], 
            punctuation_char=data_setting['punctuationL'], special_tokens=[], merge_special=False
        )
